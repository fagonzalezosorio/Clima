...
#agregamos el total de los datos filtrados
df_filtered = df_filtered.reset_index(drop = True)
total_row = pd.DataFrame({'Fecha': ['Total'], 'mm': [df_filtered.mm.sum()]})
df_tabla = pd.concat([df_filtered[['Fecha','mm']], total_row], ignore_index=True)

df_tabla = df_filtered[['Fecha','mm']]

col2.dataframe(df_tabla,  height=360)
